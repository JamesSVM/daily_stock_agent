...
def simulate_portfolio(
    ...
    The signal/entry/exit rules are intentionally unchanged. This layer adds
    position sizing, concurrency limits, cash accounting, transaction costs,
    score-priority selection, and a daily marked-to-market equity curve.
    """
